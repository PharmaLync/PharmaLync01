...
import { FileText, Clock, CheckCircle2, AlertCircle, X, Download, Printer, ArrowLeft } from 'lucide-react';
            ...
            <AnimatePresence mode="wait">
                {!selectedRx ? (
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0, x: 20 }}
                        transition={{ duration: 0.2 }}
                        className="bg-white dark:bg-slate-900 min-h-[80vh] rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 relative z-10 flex flex-col print:h-auto print:shadow-none print:w-full print:rounded-none print:border-0"
                    >
                        {/* Header Actions */}
                        ...
                        {/* Scrollable Content */}
                        <div className="flex-1 p-6 sm:p-8 print:overflow-visible">
