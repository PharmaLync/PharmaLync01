            ...
            <header className="sticky top-0 z-50 w-full glass-header px-6 py-3 flex items-center justify-between border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md transition-colors duration-300">
                <div className="flex items-center gap-3">
                    ...
                    <div className="hidden sm:block">
                        <span className="text-xs text-slate-500 dark:text-slate-400 font-medium ml-2">Doctor Portal</span>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                    <Button
                        ...
                        className="relative text-slate-500 hover:text-teal-700 dark:text-slate-400 dark:hover:text-teal-400"
                    >
                        <Bell size={20} />
                    ...
                    <div className="flex items-center gap-3">
                        <div className="text-right hidden sm:block">
                            <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">Dr. Sharma</p>
                            <p className="text-xs text-slate-500 dark:text-slate-400">General Physician</p>
                        </div>
